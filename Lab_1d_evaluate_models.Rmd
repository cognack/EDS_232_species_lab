...
## 1.1 Split observations into training and testing (mod)
```{r}
# create training set with 80% of full data
pts_split  <- rsample::initial_split(
  pts, prop = 0.8, strata = "present")
...
## 3.1 Area Under the Curver (AUC), Reciever Operator Characteristics (ROC) Curve and Confusion Matrix
